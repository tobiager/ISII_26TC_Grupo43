-- ============================================================
-- RESET + SEED EXTENDIDO - Clinicks / Sistema de Gestión Médica
-- PostgreSQL / Supabase
--
-- Carga pensada para demo y pruebas:
--   - 24 provincias y 120 localidades
--   - 10 obras sociales
--   - roles del schema actual y usuarios base con contraseña predeterminada
--   - 50 pacientes
--   - fichas médicas con alergias, enfermedades crónicas y antecedentes
--   - contactos de emergencia y teléfonos
--   - hospital con 7 pisos y 40 habitaciones
--   - 1 historial clínico por paciente
--   - registros clínicos variados con antigüedad de hasta 30 años
--   - internaciones con registros asociados en el historial, incluyendo alta médica
--
-- IMPORTANTE:
-- El esquema actual no tiene FK directa entre registro_clinico e internacion.
-- Por eso, los registros de "Ingreso a internación", "Evolución internación"
-- y "Alta médica" quedan dentro del historial del paciente y mencionan la
-- internación/habitación en la descripción.
-- ============================================================
