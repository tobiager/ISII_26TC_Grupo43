...
class PacienteServiceImplTest {
    ...
    @Nested
    class ValidacionesRegistroPaciente
    {
        @Nested
        class ValidacionesCrearPaciente
        {
            @Test
        ...
        @Nested
        class ValidacionesActualizarPaciente
        {
            @Test
        ...
        @Nested
        class ValidacionesObtenerPacientePorId 
        {
            @Test
        ...
        @Nested
        class ValidacionesEliminarPaciente
        {
            @Test
        ...
        @Nested
        class ValidacionesRestaurarPaciente
        {
            @Test
        ...
        @Nested
        class ValidacionesExisteAfiliado
        {
            @Test
        ...
        @Nested
        class ValidacionesObtenerTodosLosPacientes
        {
            @Test
